...
export const INITIAL_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    equipment: 'Cable',
    mechanic: 'Compound',
    muscle_ids: ['glutes', 'hamstrings', 'lower_back'],
  ...
  },
  {
    ...
    equipment: 'Barbell',
    mechanic: 'Compound',
    muscle_ids: ['lats', 'biceps', 'lower_back'],
  ...
  },
  {
    ...
    equipment: 'Dumbbell',
    mechanic: 'Compound',
    muscle_ids: ['lats', 'biceps', 'abs', 'obliques'],
  ...
  // --- LATS (New Additions) ---
  {
    ...
    equipment: 'Barbell',
    mechanic: 'Compound',
    muscle_ids: ['lats', 'biceps', 'lower_back', 'abs'],
  ...
  },
  {
    ...
    equipment: 'Dumbbell',
    mechanic: 'Compound',
    muscle_ids: ['lats', 'abs', 'obliques', 'biceps'],
  ...
  },
  {
    ...
    mechanic: 'Compound',
    difficulty: 'Intermediate',
    muscle_ids: ['traps', 'forearms', 'abs', 'quads'],
  ...
  // --- LEGS ---
  {
    ...
    equipment: 'Barbell',
    mechanic: 'Compound',
    muscle_ids: ['quads', 'glutes', 'abs', 'lower_back'],
  ...
  },
  {
    ...
    equipment: 'Barbell',
    mechanic: 'Compound',
    muscle_ids: ['hamstrings', 'glutes', 'lower_back', 'forearms'],
  ...
  // --- SHOULDERS ---
  {
    ...
    equipment: 'Barbell',
    mechanic: 'Compound',
    muscle_ids: ['shoulders', 'triceps', 'abs'],
  ...
  },
  {
    ...
    equipment: 'Smith Machine',
    mechanic: 'Compound',
    muscle_ids: ['shoulders', 'traps', 'biceps'],
  ...
  // PUSH
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['chest', 'triceps', 'shoulders', 'abs'],
  ...
  },
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['triceps', 'chest', 'shoulders'],
  ...
  },
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['shoulders', 'triceps', 'chest'],
  ...
  },
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['chest', 'shoulders', 'triceps'],
  ...
  },
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['lats', 'biceps', 'shoulders'],
  ...
  },
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['quads', 'glutes', 'calves'],
  ...
  // CARDIO (Expanded)
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['cardio', 'quads', 'chest', 'triceps', 'abs'],
  ...
  },
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['cardio', 'abs', 'shoulders'],
  ...
  },
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['cardio', 'calves', 'shoulders'],
  ...
  },
  {
    ...
    equipment: 'Bodyweight',
    mechanic: 'Compound',
    muscle_ids: ['cardio', 'quads', 'glutes'],
